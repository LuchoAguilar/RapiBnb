                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                            ...
                            <div class="collapse navbar-collapse RapiBnB-nav" id="navbarNav">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item ml-auto">
                                        <a class="nav-link" style="color: #CCCCCC;" href="<?= URL_PATH ?>/OfertaAlquiler/home">Publicaciones</a>
                                    </li>
                                    <li class="nav-item ml-auto">
                                        <a class="nav-link" style="color: #CCCCCC;" href="<?= URL_PATH ?>/Rentas/home">Rentas</a>
                                    </li>
                                    <li class="nav-item ml-auto dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="<?= URL_PATH ?>/Usuario/home/">Perfil</a>
                                            <a class="dropdown-item" href="<?= URL_PATH ?>/Usuario/LogOut/">Cerrar Sesión</a>
                                        </div>
                                    </li>
                                </ul>
                            </div> 
