             ...
             <div style="padding: 3rem !important; display: flex; justify-content: center;">
                 <div style="width: 400px; background-color: #f0f0f0; border-radius: 10px; padding: 20px;">
                     <div style="text-align: center;">
                         <img src="${URL_PATH}/Assets/images/fotoPerfil/${data.fotoRostro}" style="border-radius: 50%; max-width: 100px;" alt="User-Profile-Image">
                     ...
                     <div>
                         ...
                         <div>
                             ...
                             <p style="font-weight: 400;">${data.nombreCompleto}</p>
                         </div>
                         <div>
                         ...
                         <div>
                             ...
                             <p style="font-weight: 400;">${data.bio}</p>
                         </div>
